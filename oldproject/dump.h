...
void DrawBrickHeap(const LevelData::BrickHeap& brickheap, TextureManagerBase& texMngr, bool flipTexV = false);
void DrawLevelData(const LevelData& level, TextureManagerBase& txmgr, bool flipTexV = false);
