...
void DrawBrickHeap(const LevelData::BrickHeap& brickheap, TextureManagerBase& texMngr, bool flipTexV) {
	glm::mat4 mat;
...
void DrawLevelData(const LevelData& level, TextureManagerBase& txmgr, bool flipTexV) {
