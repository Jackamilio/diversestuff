...
public:
	...
	inline void SetUniform(const std::string& name, const std::vector<int>& vals) { glUniform1iv(GetUniform(name), vals.size(), (int*)&vals[0]); }
	...
	inline void SetUniform(const std::string& name, const std::vector<float>& vals) { glUniform1fv(GetUniform(name), vals.size(), (float*)&vals[0]); }
	...
	inline void SetUniform(const std::string& name, const std::vector<glm::vec3>& vals) { glUniform3fv(GetUniform(name), vals.size(), (float*)&vals[0]); }
	...
	inline void SetUniform(const std::string& name, const std::vector<glm::vec4>& vals) { glUniform4fv(GetUniform(name), vals.size(), (float*)&vals[0]); }
	...
	inline void SetUniform(const std::string& name, const std::vector<glm::mat4x2>& vals) { glUniformMatrix4x2fv(GetUniform(name), vals.size(), false, (float*)&vals[0][0]); }
	...
	inline void SetUniform(const std::string& name, const std::vector<glm::mat2x4>& vals) { glUniformMatrix2x4fv(GetUniform(name), vals.size(), false, (float*)&vals[0][0]); }
	...
	inline void SetUniform(const std::string& name, const std::vector<glm::mat3>& vals) { glUniformMatrix3fv(GetUniform(name), vals.size(), false, (float*)&vals[0][0]); }
	...
	inline void SetUniform(const std::string& name, const std::vector<glm::mat4>& vals) { glUniformMatrix4fv(GetUniform(name), vals.size(), false, (float*)&vals[0][0]); }
};
