...
LABEL_ARG(label)
OPTIONAL_BOOL_POINTER_ARG(p_visible)
OPTIONAL_INT_ARG(flags, 0)
...
OPTIONAL_INT_ARG(flags, 0)
CALL_FUNCTION(IsItemClicked, bool, flags)
PUSH_BOOL(ret)
END_IMGUI_FUNC
